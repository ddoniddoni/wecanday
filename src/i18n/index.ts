...
void i18n.use(initReactI18next).init({
  ...
  ns: ['auth', 'billing', 'challenges', 'common', 'community', 'companion', 'friends', 'legal', 'notifications', 'onboarding', 'plans', 'profile', 'routineDay', 'routineExecution', 'settings', 'statistics', 'today'],
